...
A zero-dependency music theory engine for computing scale notes, resolving diatonic modes, navigating key relationships, and building note display maps.
...
- **MIDI & frequency:** `noteToMidi`, `midiToNote`, `noteToFrequency` (scientific pitch notation, equal temperament)
