...
The music theory engine powering [PlayByKey](https://playbykey.com), a free interactive music theory learning tool. No external API calls, no runtime overhead - drop it into any JavaScript or TypeScript project and start computing immediately.
